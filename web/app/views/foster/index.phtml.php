...
<head>
	...
	<meta name="description" content ="A temporary home for a pet is better than staying at a shelter, where supplies and human interaction are often limited">
	<title>Fostering - Information on fostering a pet</title>
</head>
<body id="b-resources">
	<?php echo $this->partial('nav-main-mobile'); ?>
		...
		<section id="content" class="layout">
			...
			<div class="video-container">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/VIT0ZekvixY" frameborder="0" allowfullscreen></iframe>
			</div><!-- video-container -->
			<article class="content-paragraph">
				Here are some concerns outlined and debunked:
			</article>
			<article class="content-paragraph">
				1. <span class="underline"><em>"I will get attached."</span></em><br/><br/>
				...
				<br/><br/>
				 ...
				 <br/><br/>
				When that animal gets adopted, you can foster another animal and giving him or her the same chance, especially an animal that needs extra love.
				Most importantly, if you want to try it out but have some fears, tell the rescue group you’re talking to or contact us and we can provide contacts to help you get started with your questions or to just jump right in and foster. We will also provide foster tips here from one of NYC’s well known trainers.
			</article>
			<br/>
			<article class="content-paragraph">
				2. <span class="underline"><em>"Isn’t that cruel to give them your home then move them to another home?"</em></span><br/><br/>
			...
			<br/>
			<article class="content-paragraph">
				3. <span class="underline">"They won’t get adopted if they’re in my home."</span></em><br/><br/>
				If you  haven’t heard of <a href="http://petfinder.com" class="link-regular" target="_blank">petfinder.com</a>, <a href="http://petango.com" class="link-regular" target="_blank">petango.com</a>, <a href="http://adoptapet.com" class="link-regular" target="_blank">adoptapet.com</a>, among many other adoption website, then welcome to one of the primary resources for rescuers to find new, loving homes for their rescued animals.  Animals in foster homes get tons of exposure online, with photos, video, and lovely descriptions in their posting.
				<br/><br/>
			...
			<br/>
			<article class="content-paragraph">Open your heart and your home to a foster today, and save a life!</article>
